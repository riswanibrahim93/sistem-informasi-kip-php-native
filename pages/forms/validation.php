       ...
       <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="../tables/datasiswa.php" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Tables Siswa
              </p>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form action="../../aksi/insert_nilai_kriteria.php" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Kode Siswa</label>
                    <input type="kode" name="kode" class="form-control" id="kode" placeholder="A1">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Siswa</label>
                    <input type="nama" name="nama" class="form-control" id="nama" placeholder="Masukkan nama siswa">
                  </div>
